 ...
 */
export function trainingEvidenceMode(attempt: Pick<InterviewAttempt, "transcriptIntegrity" | "transcript" | "audioMetrics" | "speechMetrics"> | null | undefined): TrainingEvidenceMode {
