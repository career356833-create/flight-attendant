...
export type InterviewPracticeConfig = { question:InterviewQuestion; attemptType:'first'|'retry'; previousAttemptId?:string; targetAirlineId?:string }
