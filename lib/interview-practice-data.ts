...
export type InterviewPracticeSourceContext = { source:'application_drill'|'mock_report'|'airline_workspace'; applicationAnswerId?:string; applicationVersionId?:string; weakness?:string; mockSessionId?:string; sourceAttemptId?:string; questionId?:string; workspaceQuestionId?:string }
