...
export const airlines: Airline[] = [
  ...
  airline('singapore_airlines', 'Singapore Airlines', 'SG', 'asia_pacific', 'full_service', ['싱가포르항공', 'SIA', 'SQ'], ['English']),
  airline('cathay_pacific', 'Cathay Pacific', 'HK', 'asia_pacific', 'full_service', ['캐세이퍼시픽', 'Cathay', 'CX'], ['English', 'Cantonese', 'Mandarin']),
  airline('ana', 'ANA', 'JP', 'asia_pacific', 'full_service', ['전일본공수', 'All Nippon Airways', '全日空'], ['Japanese', 'English']),
  airline('japan_airlines', 'Japan Airlines', 'JP', 'asia_pacific', 'full_service', ['일본항공', 'JAL', '日本航空'], ['Japanese', 'English']),
  ...
  airline('emirates', 'Emirates', 'AE', 'middle_east', 'full_service', ['에미레이트 항공', '에미레이트항공', 'EK'], ['English']),
  airline('qatar_airways', 'Qatar Airways', 'QA', 'middle_east', 'full_service', ['카타르 항공', '카타르항공', 'Qatar', 'QR'], ['English', 'Arabic']),
  airline('etihad_airways', 'Etihad Airways', 'AE', 'middle_east', 'full_service', ['에티하드 항공', '에티하드항공', 'Etihad', 'EY'], ['English', 'Arabic']),
  ...
  airline('lufthansa', 'Lufthansa', 'DE', 'europe', 'full_service', ['LH', '루프트한자', '루프트한자항공'], ['German', 'English']),
  airline('air_france', 'Air France', 'FR', 'europe', 'full_service', ['AF', '에어프랑스'], ['French', 'English']),
  airline('klm', 'KLM', 'NL', 'europe', 'full_service', ['KLM Royal Dutch Airlines', 'KLM 네덜란드항공', '네덜란드항공'], ['Dutch', 'English']),
  airline('british_airways', 'British Airways', 'GB', 'europe', 'full_service', ['BA', '영국항공', '브리티시 에어웨이스'], ['English']),
  airline('turkish_airlines', 'Turkish Airlines', 'TR', 'europe', 'full_service', ['터키항공', '튀르키예항공', 'THY', 'TK'], ['Turkish', 'English']),
  ...
  airline('delta_air_lines', 'Delta Air Lines', 'US', 'north_america', 'full_service', ['Delta', 'DL', '델타항공', '델타 항공'], ['English']),
  airline('united_airlines', 'United Airlines', 'US', 'north_america', 'full_service', ['United', 'UA', '유나이티드항공', '유나이티드 항공'], ['English']),
  airline('american_airlines', 'American Airlines', 'US', 'north_america', 'full_service', ['American', 'AA', '아메리칸항공', '아메리칸 항공'], ['English']),
  airline('southwest_airlines', 'Southwest Airlines', 'US', 'north_america', 'low_cost', ['Southwest', 'WN'], ['English']),
  airline('air_canada', 'Air Canada', 'CA', 'north_america', 'full_service', ['AC', '에어캐나다', '에어 캐나다'], ['English', 'French']),
