...
export const airlines: Airline[] = [
  ...
  airline('emirates', 'Emirates', 'AE', 'middle_east', 'full_service', ['에미레이트 항공', 'EK'], ['English']),
  airline('qatar_airways', 'Qatar Airways', 'QA', 'middle_east', 'full_service', ['카타르 항공', 'Qatar', 'QR'], ['English', 'Arabic']),
  airline('etihad_airways', 'Etihad Airways', 'AE', 'middle_east', 'full_service', ['에티하드 항공', 'Etihad', 'EY'], ['English', 'Arabic']),
