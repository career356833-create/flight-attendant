...
test("master profiles do not invent operation scope beyond explicit official overrides", () => {
  const explicitOfficialScopes = new Set(["jeju_air", "jin_air", "air_busan", "air_seoul", "eastar_jet", "emirates", "qatar_airways", "etihad_airways", "singapore_airlines", "cathay_pacific", "ana", "japan_airlines", "turkish_airlines"]);
