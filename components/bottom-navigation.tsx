...
export function DesktopNavigation({active,onChange}:BottomNavigationProps){
  return <aside className="hidden h-full w-[232px] shrink-0 flex-col border-r border-white/10 bg-navy px-4 py-6 text-ivory min-[900px]:flex xl:w-[248px]" aria-label="주요 메뉴">
    <div className="px-3"><span className="text-xs font-bold tracking-[0.2em] text-gold">CABIN</span><p className="mt-2 text-lg font-bold">AI Career Coach</p></div>
    ...
    <div className="rounded-2xl border border-white/10 bg-white/5 p-4"><p className="text-xs text-ivory/60">오늘의 준비</p><p className="mt-2 text-sm font-semibold">한 번의 연습을 기록해보세요.</p></div>
  </aside>
}
